...
import BasicBuildingBlocks.enums.CellType;
    ...
    import AllPerformingFunctions.VehicleGeneration;




import AllPerformingFunctions.SlotAllocation;

    import AllPerformingFunctions.ParkingService;
import java.util.*;
...
public class WorkingSimulation {
    ...
    public WorkingSimulation(Parking area) {
        this.area = area;
                    this.gen = new VehicleGeneration();this.alloc = new SlotAllocation();this.path = new ParkingService();
        this.clock = 0;
    }
